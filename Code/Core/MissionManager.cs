...
public sealed class MissionManager : Component
{
	...
	private static readonly List<MissionDefinition> DailyPool = new()
	{
		...
		// ── COLLECTION ──────────────────────────────────────────
		new() { Id = "contractor", Name = "Contractor", Description = "Catch 3 monsters", Category = MissionCategory.Collection, Tier = MissionTier.Daily, Target = 3, GoldReward = 5000, InkReward = 15, Icon = "ui/icons/missions/collection.svg" },
		new() { Id = "element_seeker", Name = "Element Seeker", Description = "Catch an elemental monster", Category = MissionCategory.Collection, Tier = MissionTier.Daily, Target = 1, GoldReward = 6000, InkReward = 10, Icon = "ui/icons/missions/collection.svg" },
		new() { Id = "rare_finder", Name = "Rare Finder", Description = "Catch a Rare or higher monster", Category = MissionCategory.Collection, Tier = MissionTier.Daily, Target = 1, GoldReward = 8000, GemReward = 3, Icon = "ui/icons/missions/collection.svg" },
	...
	private static readonly List<MissionDefinition> WeeklyPool = new()
	{
		...
		new() { Id = "collection_spree", Name = "Collection Spree", Description = "Catch 20 monsters", Category = MissionCategory.Collection, Tier = MissionTier.Weekly, Target = 20, GoldReward = 25000, InkReward = 20, GemReward = 3, Icon = "ui/icons/missions/collection.svg" },
		...
		new() { Id = "element_master", Name = "Element Master", Description = "Catch monsters of 5 different elements", Category = MissionCategory.Collection, Tier = MissionTier.Weekly, Target = 5, GoldReward = 30000, GemReward = 3, InkReward = 10, Icon = "ui/icons/missions/collection.svg" },
	...
	private static readonly List<MissionDefinition> MonthlyPool = new()
	{
		...
		new() { Id = "beast_collector", Name = "Beast Collector", Description = "Catch 200 monsters", Category = MissionCategory.Collection, Tier = MissionTier.Monthly, Target = 200, GoldReward = 200000, GemReward = 30, Icon = "ui/icons/missions/collection.svg" },
