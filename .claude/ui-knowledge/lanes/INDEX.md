...
boundaries. **The canonical truth stays in the sources** — `guiding-star.md`, `learnings.md`,
...
| **DOC-7** | [Engine Laws](DOC-7-engine-laws.md) | The hard s&box constraints no design overrides — a symptom-grouped index into the CLAUDE.md quirks table and learnings.md. |
